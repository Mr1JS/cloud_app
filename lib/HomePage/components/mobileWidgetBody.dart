...
class MobileWidgetBody extends StatefulWidget {
  const MobileWidgetBody({super.key});

  @override
  State<MobileWidgetBody> createState() => _MobileWidgetBodyState();
}

class _MobileWidgetBodyState extends State<MobileWidgetBody> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final items = homeController.getFileItems(searchQuery: searchBar.query);
          ...
          itemBuilder: (context, index) {
            ...
            return Padding(
              ...
              child: ListTile(
                ...
                onTap: () {
                  if (item.isFolder) {
                    setState(() => homeController.toggleFolder(item.fullPath));
                  } else {
